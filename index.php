...
slideshow: false
        ...
        <div class="colgroup">
            <div class="col-1-4">
                <h5>Col 1/4</h5>
                <p>Vestibulum id ligula porta felis euismod semper. Etiam porta sem malesuada magna mollis euismod.</p>
            </div>
            <div class="col-1-4">
                <h5>Col 1/4</h5>
                <p>Nullam quis risus eget urna mollis ornare vel eu leo. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
            </div>
            <div class="col-1-4">
                <h5>Col 1/4</h5>
        ...
        <div class="colgroup">
            <div class="col-2-3">
                <h5>Col 2/3</h5>
                <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur et nulla sed nulla. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec sed odio dui.</p>
            </div>
            <div class="col-1-3">
                <h5>Col 1/3</h5>
                <p>Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis.</p>
            </div>
        </div>
        <div class="colgroup">
            <div class="col-1-8">
